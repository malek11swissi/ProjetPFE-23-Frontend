...
export class MarchandListComponent implements OnInit {
 ...
 form_Update_Marchand: FormGroup;
  ...
  get libelle() {return this.form_Add_Marchand .get("libelle")}
  get telephone() {return this.form_Add_Marchand .get("telephone")}
  get login() {return this.form_Add_Marchand .get("login")}
  get password() {return this.form_Add_Marchand .get("password")}
  get gouvernorat() {return this.form_Add_Marchand .get("gouvernorat")}

  get libelleU() {return this.form_Update_Marchand .get("libelleU")}
  get telephoneU() {return this.form_Update_Marchand .get("telephoneU")}
  get loginU() {return this.form_Update_Marchand .get("loginU")}
  get gouvernoratU() {return this.form_Update_Marchand .get("gouvernoratU")}
  ...
  addNewMarchand(content) {
    ...
    this.modalService.open(content, {windowClass:'customModal' , backdrop: 'static', keyboard: false, centered: true}).result.then(
			(result) => {
  ...
  onSubmit() {
      ...
      if(this.operation=='add')
      {
        ...
        this.userService.addMarchand(this.marchand)
      ...
      if(this.operation=='update')
      {
        ...
        this.userService.updateMarchand(this.marchandU)
        .subscribe(data => console.log(data), error => console.log(error) , () => {
  ...
  {
    this.userService.getMarchand(id)
    .subscribe(data => {
  ...
  updateMarchand(id:number , contentUpdate:any)
  {
    ...
    this.getMarchand(id);
    this.modalService.open(contentUpdate, {windowClass:'customModal' , backdrop: 'static', keyboard: false, centered: true}).result.then(
			(result) => {
  ...
  {
    this.modalService.open(contentDelete, { windowClass: 'customModal', backdrop: 'static', keyboard: false, centered: true });
  ...
  {
    this.userService.deleteUser(this.deletedMarchandId)
      .subscribe(
        data => {
        },
        error => console.log(error) , () => {
