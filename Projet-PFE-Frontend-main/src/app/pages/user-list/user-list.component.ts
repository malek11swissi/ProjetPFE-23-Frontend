...
export class UserListComponent implements OnInit {
 ...
 form_update_user: FormGroup;
  ...
  get libelle() {return this.form_update_user .get("libelle")}
  get telephone() {return this.form_update_user .get("telephone")}
  ...
  confirmDeleteUser()
  {
    this.userService.deleteUser(this.deletedCentreRechargeId)
      .subscribe(
        data => {
        },
        error => console.log(error) , () => {
