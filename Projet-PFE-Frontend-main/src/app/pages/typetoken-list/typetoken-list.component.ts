...
export class TypetokenListComponent implements OnInit {
  ...
  getAllTypeToken() {
     this.typetokenService.getTypeTokenList().subscribe(res => {
      this.typetokens = res
     } , error => {
      console.error(error)
     });
  ...
  get libelle() {return this.form_add_type_token.get("libelle")}
  get prix() {return this.form_add_type_token.get("prix")}

  get libelleU() {return this.form_update_type_token.get("libelleU")}
  get prixU() {return this.form_update_type_token.get("prixU")}
 ...
 console.log('typetoken' , this.typetoken)
   this.typetokenService.saveTypeToken(this.typetoken)
  ...
  {
    this.typetokenService.getTypeToken(id)
    .subscribe(data => {
      console.log(data)
      this.typetoken = data;
  ...
  confirmDeleteToken()
  {
    this.typetokenService.deleteTypeToken(this.deletedTokenId)
      .subscribe(
        data => {
        },
        error => console.log(error) , () => {
