...
export class ProfileComponent implements OnInit {
  ...
  constructor(private profileService: ProfileService,
    ...
    get username() {return this.form_Update_Profile.get("username")}
    get telephone() {return this.form_Update_Profile.get("telephone")}
    get libelle() {return this.form_Update_Profile.get("libelle")}
    get gouvernorat() {return this.form_Update_Profile.get("gouvernorat")}
    ...
    save() {
      ...
      this.profileService.updateLoggedProfile(this.profile)
        .subscribe(data => {
    ...
    getProfile()
    {
      this.profileService.getLoggedProfile().subscribe(res => {
        this.profile = res;
