...
export class CompteurListComponent implements OnInit {
  ...
  get libelle() {return this.form_Add_Compteur .get("libelle")}
  get libelleU() {return this.form_Update_Compteur .get("libelleU")}
  ...
  save() {
   ...
   this.compteurService.saveCompteur(this.compteur)
  ...
  {
    this.compteurService.getCompteur(id)
    .subscribe(data => {
      this.compteur = data;
  ...
  {
    this.compteurService.deleteCompteur(this.deletedCompteurId)
      .subscribe(
        data => {
        },
        error => console.log(error) , () => {
